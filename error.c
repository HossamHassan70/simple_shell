...
/**
 * message_selector :- This function to Select the message
 *	that match with the error_code.
 * @info: A General information about the shell.
 * Return: An Error message (error code).
 ***/
...
/**
 * error - This function Prints the error message.
 * @info: A General information about the shell.
 * Return: Void.
 ***/
...
/**
 * error_extra :- More than previous function this Print the
